  ...
  sections: [
    {
      ...
      analysiss: [
        ...
        {
          title: "Տարածական բարդություն",
          logo_path: "space-complexity.png",
          description: [
            "Տարածական բարդությունը պայմանավորված է O(1)նրանով, որ լրացուցիչ փոփոխական է օգտագործվում փոխանակման համար:",
            "Օպտիմիզացված փուչիկների տեսակավորման ալգորիթմում օգտագործվում են երկու լրացուցիչ փոփոխականներ: Այսպիսով, տարածական բարդությունը կլինի O(2).",
          ],
          color: "#9b1578",
        },
      ],
    },
    {
      ...
      analysiss: [
        ...
        },
        {
          ...
          logo_path: "space-complexity.png",
          description: [
            "Կոկտեյլային սորտի տարածական բարդությունը O(1) է:",
          ],
          color: "#9b1578",
        },
      ],
    },
    {
      ...
      analysiss: [
        ...
        },
        {
          ...
          logo_path: "space-complexity.png",
          description: [
            "Տարածական բարդությունը պայմանավորված է նրանով, որ օգտագործվում է O(1) լրացուցիչ փոփոխական : key",
          ],
          color: "#9b1578",
        },
      ],
    },
    {
      ...
      analysiss: [
        ...
        },
        {
          ...
          logo_path: "space-complexity.png",
          description: [
            "Shall տեսակավորման տարածական բարդությունը O(1) է:",
          ],
          color: "#9b1578",
        },
      ],
    },
    {
      ...
      analysiss: [
        ...
        },
        {
          ...
          logo_path: "space-complexity.png",
          description: [
            "Marge տեսակավորման տարածական բարդությունը O(n) է:",
          ],
          color: "#9b1578",
        },
      ],
    },
    {
      ...
      analysiss: [
        ...
        },
        {
          ...
          logo_path: "space-complexity.png",
          description: [
            "Տարածական բարդությունը արագ տեսակավորման համար է O(log n).",
          ],
          color: "#9b1578",
        },
      ],
